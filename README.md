# Code100 Competition - Ruby Sample

This codebase contains everything you need to complete coding challenges of the Code100 competition in Ruby.
The code example of communicating with the API is already present in the `code100.rb` file in the `test-project` folder.
